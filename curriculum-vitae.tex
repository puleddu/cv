...
% ---- FILL IN HERE THE TITLE AND AUTHOR
	pdftitle={Antonio Piu},
	pdfauthor={Antonio Piu}
]{hyperref}  
...
Email \href{mailto:me@antoniopiu.com}{me@antoniopiu.com}\\
Portfolio \href{http://antoniopiu.com/}{http://antoniopiu.com}\\

\begin{figure}[htbp]
\includegraphics[height=4.7cm, width=5cm,keepaspectratio]{photo.jpg}
\end{figure}
...
\begin{itemize}
\item Involved, as a project manager, in the specification and development \\of a web-based \emph{Intellectual Property} software, cross-browser testing.
...
\years{2008-2009}\textbf{Blackbit, Stud io Associato}\\ 
...
Department of Political Sciences, Via Serafini 3, 56126 Pisa, Italy\\
...
Via Giuntini 25, Navacchio di Cascina (\textsc{pi}), Italy\\
...
\years{Technical} Adobe\textregistered Photoshop\textregistered, Adobe\textregistered Illustrator\textregistered, \textsc{html}, \textsc{css}, \textsc{Sass/Less}  (professional proficiency)\\ 
